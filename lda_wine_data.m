...
%
%Wine data example form
% http://archive.ics.uci.edu/ml/datasets/Wine

clear all; close all;

%load data
% data = dlmread('wine_data/wine_data.txt',',');
data = dlmread('wine/wine.data',',');
y = data(:,1);
X = data(:,2:end);

% 178 instances with 13 attributes from 3 classes
% n is num of samples
